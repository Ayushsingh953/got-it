        ...
        const fetchData=async () =>{
          ...
          fetchData();
           ...
           const fetchbookData=async () =>{
            ...
            try { 
                const bookdata=await axios.get("http://localhost:5500/profile/book",bookconfig);
           ...
           const fetchclothData=async () =>{
            ...
            try { 
                const clothdata=await axios.get("http://localhost:5500/profile/cloth",clothconfig);
           ...
           const fetchfoodData=async () =>{
            ...
            try { 
                const fooddata=await axios.get("http://localhost:5500/profile/food",foodconfig);
           ...
           const fetchtoyData=async () =>{
            ...
            try { 
                const toydata=await axios.get("http://localhost:5500/profile/play",toyconfig);
           ...
           const fetchmedData=async () =>{
            ...
            try { 
                const meddata=await axios.get("http://localhost:5500/profile/heal",medconfig);
                ...
                <div className="row">
                    <div className="col-sm-12">
                        ...
                        <div className="profile-user-box card-box bg-custom">
                                <div className=" mr-3"><img src={`http://localhost:5500/${user.image}`} alt="" className="thumb-lg rounded-circle" /></div>
